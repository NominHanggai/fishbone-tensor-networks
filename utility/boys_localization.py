...
s3s2_elem = np.zeros([3, 3]);
s3s2_elem[0, 1] = 1;
s3s2_elem = s3s2_elem + s3s2_elem.T
s3s1_elem = np.zeros([3, 3]);
s3s1_elem[0, 2] = 1;
s3s1_elem = s3s1_elem + s3s1_elem.T
s2s1_elem = np.zeros([3, 3]);
s2s1_elem[1, 2] = 1;
s2s1_elem = s2s1_elem + s2s1_elem.T
s3_elem = np.zeros([3, 3]);
s3_elem[0, 0] = 1
s2_elem = np.zeros([3, 3]);
s2_elem[1, 1] = 1
s1_elem = np.zeros([3, 3]);
s1_elem[2, 2] = 1
